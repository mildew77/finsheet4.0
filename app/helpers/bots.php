...
***********************************************************************/
public static function http_get($target, $ref)
    {
    return BOTS::http($target, $ref, 'GET', $data_array="", FALSE);
    }
	/***********************************************************************
...
OUTPUT:                                                                 
        ...
        $return_array['ERROR']  = CURL generated error status           
***********************************************************************/
public static function http_get_form($target, $ref, $data_array)
    {
    return BOTS::http($target, $ref, 'GET', $data_array, EXCL_HEAD);
    }
...
OUTPUT:                                                                 
        ...
        $return_array['ERROR']  = CURL generated error status           
***********************************************************************/
public static function http_get_form_withheader($target, $ref, $data_array)
    {
    return BOTS::http($target, $ref, 'GET', $data_array, INCL_HEAD);
    }
...
OUTPUT:                                                                 
        ...
        $return_array['ERROR']  = CURL generated error status           
***********************************************************************/
public static function http_get_withheader($target, $ref)
    {
    return BOTS::http($target, $ref, 'GET', $data_array="", INCL_HEAD);
    }
...
public static function http($target, $ref, $method, $data_array, $incl_head)
	...
	curl_setopt($ch, CURLOPT_COOKIEJAR, 'C:\wamp\www\finsheet\app\helpers\cookie.txt');   // Cookie management.
	curl_setopt($ch, CURLOPT_COOKIEFILE, 'C:\wamp\www\finsheet\app\helpers\cookie.txt');
	curl_setopt($ch, CURLOPT_TIMEOUT, 25);    // Timeout
	curl_setopt($ch, CURLOPT_USERAGENT, "Mozilla/4.0 (compatible; MSIE 5.01; Windows NT 5.0)");   // Webbot name
